...
async def approve(_, m : Message):
    ...
    try:
        ...
        await app.send_message(kk.id, "**Hello {}!\nWelcome To {}\n\n__Powerd By : @KC_BOTZ __**".format(m.from_user.mention, m.chat.title))
        add_user(kk.id)
...
async def op(_, m :Message):
    ...
    keyboard = InlineKeyboardMarkup(
        [[
            InlineKeyboardButton("🗯 Channel", url="https://t.me/KC_BOTZ"),
            InlineKeyboardButton("💬 Support", url="https://t.me/KC_BOTZ")
        ]]
    )
